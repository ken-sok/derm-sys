...
class UsersModel{
	...
	static public function mdlAddUser($table, $data){
		...
		$stmt = Connection::connect()->prepare("INSERT INTO $table(name, user, password) VALUES (:name, :user, :password)");
	...
	static public function mdlEditUser($table, $data){
		...
		$stmt = Connection::connect()->prepare("UPDATE $table set name = :name, password = :password WHERE user = :user");
