...
<head>
  ...
  <link rel="icon" href="views/img/template/logo-small-blue-bg.jpg">
  ...
  <script src="views/plugins/input-mask/jquerymaskphone.js"></script>
  <!-- jQuery Number -->
...
<!-- Site wrapper -->
  ...
  <?php
      ...
      if(isset($_GET["route"])){
        ...
        include "modules/create-sale.php";
